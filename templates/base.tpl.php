...
<body class="text-center">
  ...
  <header class="masthead mb-auto">
    <div class="inner">
      <h3 class="masthead-brand">My Bloger</h3>
      <nav class="nav nav-masthead justify-content-center">
        
        <?php if(isset($user)){ ?>
          <a class="nav-link active" href="<?=BASE;?>user/dashboard">Home</a>
        <a class="nav-link" href="<?=BASE;?>post/profile"><?= implode($this->session->get('user'));?></a>
        ...
        <?php }else{ ?>
          ...
          <a class="nav-link" href="<?=BASE;?>index/contact">Contacto</a>
